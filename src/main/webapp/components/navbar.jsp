...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>Threads&Co.</i></h3></a>
...
<div class="text-right">
    <p style="font-size:25px;"><b>Total Price :PKR<%=new CartDaoImp().totalPriceFromCart(user.getUserId()) %>/- </b></p> 
</div>
<hr>
<div class="row">
...
<div class="text-right">
    <p style="font-size:25px;"><b>Total Price :PKR<%=new OrderDaoImp().totalOrderPrice(user.getUserId()) %>/- </b></p> 
</div>
<hr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phonee.png" style="width:27px;" alt="img">021 365829218 / +92 3332093431<br>
                <img src="images/emaill.png" style="width:29px;" alt="img">thread&co@gmail.com
            </b>
        </p>
        </div>
      </div>
